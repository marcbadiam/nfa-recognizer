...
public interface NFAGrammarListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link NFAGrammarParser#nfa}.
	 * @param ctx the parse tree
	 */
	void enterNfa(NFAGrammarParser.NfaContext ctx);
	/**
	 * Exit a parse tree produced by {@link NFAGrammarParser#nfa}.
	 * @param ctx the parse tree
	 */
	void exitNfa(NFAGrammarParser.NfaContext ctx);
	/**
